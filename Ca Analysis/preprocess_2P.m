function [nTrials, root] = preprocess_2P(root)
%Preprocesses Imaging Data from 2-Photon (needs -mat file from
%SpeedTracker)
%   Detailed explanation goes here


%% Initialize system defaults. DO NOT EDIT THIS BLOCK
...
%% Start Program
% root = uigetdir(pwd,'Choose Data Folder');
numSubtrials = input('How many orientations per trial? ');
disp('Loading Data...')
...
disp('All mat files loaded')
    ...
    function easteregg = funcY 
        %EASTER EGG!!! 
        easteregg = evalin('base','exist(''easteregg'', ''var'')');
        if easteregg
            easteregg = 1;
            disp('You found the easter egg!!')
        end
    end
