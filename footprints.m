function varargout = footprints(varargin)
% FOOTPRINTS MATLAB code for footprints.fig
%      FOOTPRINTS, by itself, creates a new FOOTPRINTS or raises the existing
%      singleton*.
%
%      H = FOOTPRINTS returns the handle to a new FOOTPRINTS or the handle to
%      the existing singleton*.
%
%      FOOTPRINTS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FOOTPRINTS.M with the given input arguments.
%
%      FOOTPRINTS('Property','Value',...) creates a new FOOTPRINTS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before footprints_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to footprints_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help footprints

% Last Modified by GUIDE v2.5 21-Dec-2016 17:35:38

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @footprints_OpeningFcn, ...
                   'gui_OutputFcn',  @footprints_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before footprints is made visible.
function footprints_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to footprints (see VARARGIN)

% Choose default command line output for footprints
handles.roiN = 0;
...
% so window can get raised using footprints.
...
% UIWAIT makes footprints wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = footprints_OutputFcn(hObject, eventdata, handles)
